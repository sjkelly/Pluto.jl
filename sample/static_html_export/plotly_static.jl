...
# ╔═╡ 74947f89-e95a-4468-b444-610eb6cfebff
using Plots

# ╔═╡ da98f872-7582-454d-bbe4-b136e6412d4d
import PlotlyBase, PlotlyKaleido, PlotlyJS, Base64

# ╔═╡ 4ec26ec1-d3cf-4803-bb8d-9cac1a8944a5
Plots.plotly()

# ╔═╡ 1fd859c8-b5e1-4d4f-b407-2eb80496a005
function Plots.plotly_html_head(plt::Plots.Plot)
	plotly_js_contents = read("plotly-2.6.3.min.js", String)
	plotly_base64 = Base64.base64encode(plotly_js_contents)
	"<script src=\"data:text/javascript;base64,$(plotly_base64)\"></script>"
end

# ╔═╡ 865eb294-5e12-42af-ac33-70f95dc32c82


# ╔═╡ 50e4dceb-f7ed-4dbd-8766-37a676580495
plot(rand(50))
...
manifest_format = "2.0"
project_hash = "376c2f23b81d271d927ee753322b26eb67bad1d0"
